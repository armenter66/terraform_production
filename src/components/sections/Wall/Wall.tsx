...
import floor from '@/assets/img/wall2.webp';
	...
	return (
		<section className={styles.wall} id='wall'>
			<div className='container'>
				<h2>
					terraform <span className='font-cormorant'>Cтіни</span>
				</h2>

				<div className={styles.wall__container}>
					<div className={styles.wall__item1}>
						<Image
							src={wall}
							width={470}
							height={320}
							alt=''
							className={styles.wall__img1}
						/>
						<Image
							src={floor}
							width={520}
							height={650}
							alt=''
							className={styles.wall__img2}
						/>
					</div>
					<div className={styles.wall__item2}>
						<p>
							Terraform дає вигляд реалістичних текстур каменю, мармуру, дерева чи
							бетону без їхніх типових мінусів: тижнів ремонту, клею, швів, пилу,
							складної логістики й перевитрат.
						</p>
						{/* <a href='#'>
							Детальніше <span>про стіни</span>
							<svg
								width='21'
								height='21'
								viewBox='0 0 21 21'
